...
**分辨率预设说明**（适用于所有含 resolution/aspect_ratio 参数的节点）:
- 预设基准值始终作用于画面**短边**（方向感知）：横屏/方形作用于高度，竖屏作用于宽度
- 例如 9:16 竖屏：1080p=1080x1920、2K=1440x2560、4K=2160x3840、8K=4320x7680；16:9 横屏：1080p=1920x1080
- 输出尺寸向下对齐到 8 的倍数（ComfyUI latent 兼容要求）
